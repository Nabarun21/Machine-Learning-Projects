...
def train(sess, load_dir=None, save_frequency=100, sample_frequency=100, sample_dir='sample_faces',
          save_dir='checkpoint', max_to_keep=20, model_name='dcgan.model',
...
with tf.Session() as sess:
    train(sess,load_dir='checkpoint',save_dir='checkpoint',sample_frequency=500,save_frequency=1000,latest_fname="dcgan.model_19001",n_epochs=15,n_generator_update=1)
#    train(sess,save_dir='checkpoint',sample_frequency=500,save_frequency=1500)
