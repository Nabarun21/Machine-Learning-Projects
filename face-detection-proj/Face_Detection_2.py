...
def generate_model(sample_shape):
    ...
    x=Conv2D(32,(3,3),kernel_initializer='he_normal',kernel_regularizer='l2')(input_img)
    x=LeakyReLU(alpha=0.1)(x)
    x=BatchNormalization()(x)
    x=Conv2D(64,(3,3),kernel_initializer='he_normal',kernel_regularizer='l2')(x)
    x=LeakyReLU(alpha=0.1)(x)
    x=BatchNormalization()(x)
    ...
    x=LeakyReLU(alpha=0.1)(x)
    x=BatchNormalization()(x)
    x=Conv2D(256,(3,3),kernel_initializer='he_normal',kernel_regularizer='l2')(x)
    x=LeakyReLU(alpha=0.1)(x)
    x=BatchNormalization()(x)
    x=MaxPooling2D()(x)
    ...
    x=LeakyReLU(alpha=0.1)(x)
    x=BatchNormalization()(x)
    x=Conv2D(512,(2,2),kernel_initializer='he_normal',kernel_regularizer='l2')(x)
    x=LeakyReLU(alpha=0.1)(x)
    x=Flatten()(x)
