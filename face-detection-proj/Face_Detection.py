...
def fit(model, datagen, X_train, Y_train, X_val, Y_val, model_name=None, output_dir="/afs/crc.nd.edu/user/n/ndev/ML_exercises/face-detection/data/checkpoints", class_weight={0:1.,1:3.}, epochs=2000, lr=0.0003):
    """Fit model.
...
fit(model_name="nabnet_4", model=model, datagen=datagen, X_train=X_train, X_val=X_val, Y_train=Y_train, Y_val=Y_val)
